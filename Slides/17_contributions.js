...
export const slide_contributions = new Slide(
	function(DOM_hexmesh)
	{
		...
		this.metatronSurface = Display.loadSurfaceView("off", Metatron.metatron_off, {transparent: true, opacity: 0.2});
		this.metatronSurface.layers.set(surfaceLayer);
		this.group.add(this.metatronSurface);

		this.metatronVol = Display.loadVolumesView("mesh", Metatron.metatron_mesh);
